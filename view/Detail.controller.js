...
//debugger;
			var ProdOrders = {
		         ...
		         //ProdOrders =  JSON.parse(ProdOrders);
                //   debugger;	
				/*	var docTy = this.byId("doc_type").getValue();
					var quantity = this.byId("qty").getValue();
					var squantity = this.byId("sqty").getValue();
					var startDte = this.byId("start_date").getValue();
					var endDate = this.byId("end_date").getValue();
                //   debugger;
					ProdOrders.d.DocType = docTy;
					ProdOrders.d.Quanity = quantity;
					ProdOrders.d.ScrapQty = squantity;
					ProdOrders.d.StartDate = startDte;
					ProdOrders.d.EndDate = endDate;*/
			//	debugger;
					
					var model = this.getView().getModel();
					debugger;
	           	 model.create("/ProdOrderSet",ProdOrders,null,function(oData){
